...
export default function OfferCard(props: OfferCardProps) {
  ...
  return (
    <div
      {...htmlProps}
      className={clx(
        'border-jbn-light-green flex h-full flex-col rounded-xl border bg-white px-32 py-32 transition delay-100 ease-out hover:scale-102 hover:shadow-lg',
        className,
      )}
    >
      <div className="flex flex-grow flex-col gap-24">
        {/* Header */}
